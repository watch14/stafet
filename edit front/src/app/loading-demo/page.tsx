        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg p-6 shadow-lg">
            ...
            <p className="text-gray-600 mb-6">
              These buttons trigger the full-screen loading overlay with
              different messages and durations.
            </p>
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={() =>
                  handleGlobalLoading("Preparing your experience...", 3000)
                }
              ...
              <button
                onClick={() =>
                  handleGlobalLoading("Processing your request...", 4000)
                }
              ...
              <button
                onClick={() =>
                  handleGlobalLoading("Sending your message...", 2500)
                }
                ...
                <div className="bg-gray-100 rounded-lg p-6 min-h-[120px] flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      This content will be overlaid with a loading screen
                    </p>
                  </div>
                </div>
              </LoadingOverlay>
