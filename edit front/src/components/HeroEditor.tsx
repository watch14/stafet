...
export default function HeroEditor({
  ...
  const resetComponent = () => {
    if (
      confirm(
        "Are you sure you want to reset the hero section to default values? This will overwrite all your changes."
      )
    ) {
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white p-3 rounded-lg border border-gray-200">
                    ...
                    <ColorPicker
                      color={draft.subtitleColor}
                      onChange={(c) => updateDraft({ subtitleColor: c })}
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <ColorPicker
                      ...
                      onChange={(c) => updateButton({ textColor: c })}
                      label="Text Color"
                    />
                  </div>
                  <div>
                    ...
                    <ColorPicker
                      ...
                      onChange={(c) => updateButton({ bgColor: c })}
